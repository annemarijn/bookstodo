...
# def loadbooks():
    ...
    scanPage("https://linguistlist.org/issues/?page=3&topic=Books")
    scanPage("https://linguistlist.org/issues/?page=2&topic=Books")
    scanPage("https://linguistlist.org/issues/?page=1&topic=Books")
